		...
		foreach($this->form_args as $field_id => $field_args) {
			...
			switch($field_args['type']) {
				...
				case 'checkbox' :
					...
					break;
				case 'color' :
					?><input type="text" class="color-field" id="<?php echo $this->get_field_id( $field_id ); ?>" name="<?php echo $this->get_field_name( $field_id ); ?>" value="<?php echo esc_attr($instance[$field_id]) ?>" /><?php
