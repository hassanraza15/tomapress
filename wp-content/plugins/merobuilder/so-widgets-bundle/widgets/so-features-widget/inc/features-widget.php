...
class SiteOrigin_Widget_Features_Widget extends SiteOrigin_Widget {
			...
			array(
				'features' => array(
					...
					'fields' => array(
						...
						'design' => array(
						'type' => 'checkbox',
						'label' => __('Alternative Design', 'siteorigin-widgets'),
						'default' => false,
						),
	...
	function enqueue_frontend_scripts(){
		wp_enqueue_style('siteorigin-features', siteorigin_widget_get_plugin_dir_url('features').'css/style.css', array(), SOW_BUNDLE_VERSION );
	}
